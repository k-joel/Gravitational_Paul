...
////////////////////////////////////////////////////////////////////////////
int CSGD_WaveManager::GetVolume(int nID)
{
	//	Error check and make sure the system has been initialized
	if (!m_dsObject)	return false;
	...
	long volume = 0;
	m_waveList[nID].dsBuffer->GetVolume(&volume);

	return 100 - volume / -30;
}
////////////////////////////////////////////////////////////////////////////
//	Function		:	"SetVolume"
//
...
//
//	Purpose			:	Gets the pan for a wave file.
//						Use a range of [-100(Left) to 100(Right)] where 0 is both speakers
////////////////////////////////////////////////////////////////////////////
int CSGD_WaveManager::GetPan(int nID)
{
		//	Error check and make sure the system has been initialized
	if (!m_dsObject)	return false;
	...
	long pan = 0;
	m_waveList[nID].dsBuffer->GetPan(&pan);

	//	Convert from dB of (-10,000, 10,000) and return
	return pan / 100;
}
...
//						sound device can support;
////////////////////////////////////////////////////////////////////////////
bool CSGD_WaveManager::GetFrequencyCapabilities(int *nMin, int *nMax)
{
	//	Error check and make sure the system has been initialized
	if (!m_dsObject)	return false;
	...
	(*nMin) = caps.dwMinSecondarySampleRate;
	(*nMax) = caps.dwMaxSecondarySampleRate;
...
////////////////////////////////////////////////////////////////////////////
int CSGD_WaveManager::GetFrequency(int nID)
{
	//	Error check and make sure the system has been initialized
	if (!m_dsObject)	return false;
	...
	DWORD freq =0;
	m_waveList[nID].dsBuffer->GetFrequency(&freq);
...
bool CSGD_WaveManager::SetFrequency(int nID, int nFreq)
{
	...
	if((unsigned int)nFreq < caps.dwMinSecondarySampleRate)
		nFreq = caps.dwMinSecondarySampleRate;
	if((unsigned int)nFreq > caps.dwMaxSecondarySampleRate)
